def create_s3_path(element_id: str) -> str:
    """
    Construct the S3 path based on the provided id.
...
def get_base_url(page_manifest: dict) -> str:
    """
    Retrieve the base URL of the IIIF server from the manifest.
...
def create_image_url(page_manifest: dict) -> str:
    """
    Create the URL for the page image using the base IIIF URL.
