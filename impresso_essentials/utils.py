...
PARTNER_TO_MEDIA = {
    ...
    "BNL": [
        ...
        "luxembourg1919",
        "luxemburgerin",
        "luxemburgervolkszeitung1871",
        "luxemburgerzeitung1868",
        "luxillustrierte",
        "luxlibre",
        "luxvolk1888",
        "luxvolksbote",
        ...
        # "memorialarlon",
        # "memorialc",
        # "memorialrecueilspecial",
        "mitteilungsblatt1941",
        "monatsrevue1911",
        "natioun",
        "neuezeit1911",
        "neuezeit1936",
    ...
    "BL": [
        # all commented out aliases are not part of the first Nuance NLP ingest
        "AATA",
        "AGE52",
        "AGMO",
        "AHEC",
...
PARTNERS_WITHOUT_OLR = ["NZZ", "SWA", "FedGaz", "BCUL", "SWISSINFO", "INA", "SUB", "RTS", "BL"]
...
NON_PRINT_MEDIA = {
    ...
    SourceMedium.AO: PARTNER_TO_MEDIA["RTS"] + PARTNER_TO_MEDIA["INA"],
}
...
PARTNERS_TO_SRC_TYPE_TO_MEDIA = {
    ...
    "BNL": {
        SourceType.RM: ["revue"],
        SourceType.NP: [j for j in PARTNER_TO_MEDIA["BNL"] if j != "revue"],
    },
